...
public class MessageController implements CommunityConstant {
    ...
    public String getNoticeList(Model model){
        User user = hostHolder.getUser();
        //查询评论类通知
        Message message = messageService.findLatestNotice(user.getId(), TOPIC_CONMMENT);
        if(message != null){
            ...
            int count = messageService.findNoticeCount(user.getId(), TOPIC_CONMMENT);
            messageVO.put("count", count);
            int unread = messageService.findNoticeUnreadCount(user.getId(), TOPIC_CONMMENT);
